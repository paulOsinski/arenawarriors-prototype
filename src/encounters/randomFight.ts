...
console.log('player 1 cards =', player1.cards, 'player 1 total pips = ', player1.stack, '\n', 'player 1 initial power =', totalPips(player1.stack), '\n');
console.log('player 2 cards =', player2.cards, 'player 2 total pips = ', player2.stack, '\n', 'player 2 initial power =', totalPips(player1.stack), '\n');
...
console.log('Player 1 pip change', player1.stack, '->', finalStacks[0], '\n', 'After comparing, player 1 final power is', totalPips(finalStacks[0]), '\n');

console.log('Player 2 pip change', player2.stack, '->', finalStacks[1], '\n', 'After comparing, player 2 final power is', totalPips(finalStacks[1]), '\n');
